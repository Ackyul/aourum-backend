...
const eventSchema = z.object({
  ...
  whatsappNumber: z.string().optional().nullable(),
  lat: z.preprocess((val) => (val === null || val === undefined || val === '') ? null : Number(val), z.number().nullable().optional()),
  lng: z.preprocess((val) => (val === null || val === undefined || val === '') ? null : Number(val), z.number().nullable().optional()),
